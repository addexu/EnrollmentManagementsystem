...
public interface CourseMapper extends BaseMapper<CourseEntity> {
    ...
    Integer countStudentCanSelect(@Param("departmentId")Integer departmentId, @Param("studentId")Integer studentId, @Param("grade")Integer grade, @Param("courseName")String courseName, @Param("teacherName")String teacherName);
